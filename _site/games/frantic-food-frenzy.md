![Frantic Food Frenzy]({{site.baseurl}}/img/frantic-food-frenzy/logo.png)
...
* A team needs a great leader to define the creative direction of the game.
* Project management can be both a great advantage and great disadvantage.
* Team work comes with some strong caveats especially when its remote only.

## Download & Play
<hr>
<p style="display: inline-block">
<a href="https://drive.google.com/uc?export=download&id=12SLdOtEvOtVFwDaDgtZ63OBh7tYRQAbG"><img width="60" src="{{site.baseurl}}/img/common/windows.png" style="display: inline-block; margin: auto;" alt="Download Game Windows" /></a>
</p>

### Trailer
<hr>
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/26N0AMmhz0U" frameborder="0" style="margin-bottom: 20px;" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## **Post-Mortem**
<hr>

Ah, this one probably over all of them has taught me the most! This was group project, comprised of 3 programmers (myself included), 3 designers and 2 artists.
